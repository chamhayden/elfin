...
const StyleHtml = ({}) => {
  ...
  return (
    <section style={{ maxWidth: 'calc(100vw - 65px)', boxSizing: 'border-box' }}>
      ...
      <Body>
        Below is our style guide for COMP1531 for writing good HTML. <b>For anything not mentioned here, refer to the <a href="https://www.w3schools.com/html/html5_syntax.asp" target="_blank" rel="noreferrer">W3 schools style guide</a>.</b>
      </Body>
      <Body>
