...
const StyleReact = ({}) => {
  ...
  return (
    <>
      ...
      <Body>The assignments in COMP1531 all have a portion of their marks allocated to code style. As such, it is <b>highly</b> recommended for students to have a read through this style guide.</Body>

      <Body>
        Below is our style guide for COMP1531 for writing good React code. <b>For anything not mentioned here, refer to the <a href="https://github.com/airbnb/javascript/tree/master/react" target="_blank" rel="noreferrer">Airbnb style guide for ReactJS</a>.</b> It is a very strict style guide so we don't enforce every principle, but do take it's guidance generally.
      </Body>
      <Body color='red'>
