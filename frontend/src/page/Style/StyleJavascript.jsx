...
const StyleJavascript = ({}) => {
  ...
  return (
    <>
      ...
      <Body>
        Below is our style guide for COMP1531 for writing good Javascript. <b>For anything not mentioned here, refer to the <a href="https://www.w3schools.com/js/js_conventions.asp" target="_blank" rel="noreferrer">W3 schools style guide</a>.</b>
      </Body>
      <Body>
