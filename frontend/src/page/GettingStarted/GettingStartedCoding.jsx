      ...
      <h2 id="windows">🍊 2. Alternative 1: Running everything locally on Windows</h2>
        ...
        <ol>
          ...
          <ol>
            ...
            <li>Run <code>nvm install 18</code>, which will download and install the correct version of NodeJS.After it completes, run the <code>node --version</code> command to check if it installed correctly. You should see something like "v18.16.0" as the output.</li>
          </ol>
          <ol>
          </ol></li>
        </ol>
