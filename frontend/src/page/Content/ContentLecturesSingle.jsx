...
const ContentLecturesSingle = ({}) => {
  ...
  return <>
    ...
    <Box sx={{ ml: 1 }}>
      ...
      <Typography variant="body1" gutterBottom>
        <a target="_blank" href={`/~cs1531/raw/lectures/${lecture.key}/`}>Access the code used in the lecture here (may be blank).</a>
      </Typography>
      <Typography variant="body1" gutterBottom>
    ...
    {lecture.visible
      ? <a href={lecture.pdf_url === undefined ? `/~cs1531/raw/lectures/${lecture.key}.pdf` : lecture.pdf_url} target="_blank"><Button variant="outlined" color="warning">View/Download PDF</Button></a>
